...
if __name__ == "__main__":
    ...
    a1 = input("Please enter the first attack stat: ")
    a2 = input("Please enter the second attack stat: ")

    ac1 = input("Please enter the first accuracy between 0 and 1: ")
    ac2 = input("Please enter the second accuracy between 0 and 1: ")

    h1 = input("Please enter the first health: ")
    h2 = input("Please enter the second health: ")
    ...
    print("")
    print("you might be looking at this and saying what is going on, but it's pretty easy once you know.")
